...
export const citations: Citation[] = [
  ...
  },
  {
    ...
    theoryIds: ['apparatus', 'modernist', 'temporal-theory'],
  ...
  // TELEVISION STUDIES - Enhanced with contemporary scholars
  {
    ...
    year: 2022,
    publisher: 'MIT Press',
    theoryIds: ['television-studies', 'queer', 'digital-media'],
  ...
  },
  {
    ...
    theoryIds: ['television-studies', 'critical-race', 'comedy-studies'],
  ...
  },
  {
    ...
    year: 2020,
    publisher: 'NYU Press',
    theoryIds: ['digital-media', 'critical-race', 'cultural'],
  ...
  },
  {
    ...
    year: 2006,
    publisher: 'Routledge',
    theoryIds: ['adaptation', 'postmodern', 'intertextuality'],
  ...
  },
  {
    ...
    year: 1988,
    publisher: 'Routledge',
    theoryIds: ['postmodern', 'metafiction', 'historiography'],
